<template>
    <div class="p-6 space-y-6">
        <!-- Loading State -->
        <div v-if="isLoading && !wallet" class="text-center py-12">
        ...
        <template v-else>
            ...
            <div class="bg-gradient-to-br from-brand to-[#d81b36] rounded-xl p-6 text-white">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p v-if="pendingBalance > 0" class="text-white/70 text-sm mt-1">
            ...
            <div class="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-xl overflow-hidden">
                <div class="p-4 border-b border-gray-200 dark:border-neutral-800">
                    <h3 class="font-semibold text-gray-900 dark:text-neutral-100">Transaction History</h3>
                </div>

                <div v-if="transactions.length === 0" class="p-8 text-center text-gray-400 dark:text-neutral-500">
...
const { wallet, isLoading, balance, pendingBalance, stats, transactions, fetchWallet, fetchTransactions, addFunds, withdraw } = useWallet()
