                        ...
                        <div class="border-t border-gray-200 dark:border-neutral-800">
                            ...
                            <div class="flex items-center justify-between p-4">
                                ...
                                <button @click="handleSave">
                                    <Icon :name="isSaved ? 'mdi:bookmark' : 'mdi:bookmark-outline'" size="26" :class="isSaved ? 'text-brand' : 'text-gray-900 dark:text-neutral-100'" />
                                </button>
                            </div>
...
const { isLoading, error, getPostById, likePost, unlikePost, savePost, unsavePost } = usePost();
