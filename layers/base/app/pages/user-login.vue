...
<template>
  <div class="relative min-h-screen overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
      <img
        src="https://nairobifashionhub.co.ke/wp-content/uploads/2023/11/Nairobi-Fashion-Hub-Nairobi-Street-Fashion-Season-2-The-Royal-Invite-03-11-2023-jpg.webp"
...
const showComingSoon = (provider: string) => {
  message.value = `${provider} sign-in coming soon – stay tuned!`
  setTimeout(() => (message.value = ''), 3400)
}
</script>
